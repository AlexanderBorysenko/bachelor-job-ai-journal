...
2. Якщо повідомлення стосуються ОДНІЄЇ теми — об'єднуй їх у зв'язні абзаци. Але якщо повідомлення стосуються РІЗНИХ тем (різні події, різні думки, різні контексти) — оформлюй їх як окремі нотатки, розділені `---`. Не зливай тематично різні повідомлення в один абзац.
...
7. Формат: Markdown. Використовуй абзаци, можеш використовувати **жирний** для акцентів.
