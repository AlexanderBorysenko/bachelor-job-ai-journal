...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "story_point_not_found": "Story point not found",
        "story_point_title_required": "Story point title can't be empty",
        "story_point_reorder_mismatch": "Reorder list must contain exactly this entry's story points",
    ...
    "uk": {
        ...
        "story_point_not_found": "Момент не знайдено",
        "story_point_title_required": "Назва моменту не може бути порожньою",
        "story_point_reorder_mismatch": "Список для впорядкування має містити саме моменти цього запису",
    ...
    "ru": {
        ...
        "story_point_not_found": "Момент не найден",
        "story_point_title_required": "Название момента не может быть пустым",
        "story_point_reorder_mismatch": "Список для сортировки должен содержать именно моменты этой записи",
